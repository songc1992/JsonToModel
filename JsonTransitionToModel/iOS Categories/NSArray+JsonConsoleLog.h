...
/**
 把数组转换成 JSON 字符串，并自动复制到粘贴板上，每次请求新接口时调用，配合 https://github.com/songc1992/JsonToModel 自动生成 model
 */
